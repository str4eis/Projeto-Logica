...
export function createLevel(
	...
	const tileDefinitions: TileDefinitions = {
		...
		'b': () => [k.sprite('Wall-bottom-middle', { frame: 1 }), k.scale(4), k.body({ isStatic: true }), k.area(), 'parede'],
		...
		']': () => [k.sprite('Door', { frame: 9 }), k.scale(4), k.body({ isStatic: true }), k.area(), 'porta'],
		'{': () => [k.sprite('Door', { frame: 6 }), k.scale(4), k.body({ isStatic: true }), k.area(), 'porta'],
		'}': () => [k.sprite('Door', { frame: 10 }), k.scale(4), k.body({ isStatic: true }), k.area(), 'porta'],
